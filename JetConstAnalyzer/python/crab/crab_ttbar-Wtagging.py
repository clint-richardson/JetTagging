...
config.General.requestName = 'JetTagging-TTbar-WJets'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'JetInfo_WJets_cfg.py'
...
config.Data.outLFNDirBase = '/store/user/%s/JetTagging/WJetTagging/' % (getUsernameFromSiteDB())

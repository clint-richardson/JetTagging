...
def trainConvTF(nVar,df_train,df_test):
    ...
    #now add second layer 2x2 so that patch size is .2 x.2 and should hopefully be able to find the subjets
    ...
    for i in range(0,3600):
        ...
        #save after training on this step
        if i%100 == 0:
            saver.save(sess, 'jet-tagger', global_step=i)

    #setup for testing


def test_CNN(nVar,df_test):
    ...
    #make session
    sess = tf.Session()
    saver.restore(sess, "jet-tagger-3500")
    #setup test data
